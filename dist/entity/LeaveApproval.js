...
__decorate(
  [
    ...
    ), // 'approvals' is the inverse side property in Leave entity
...
__decorate(
  [
    (0, typeorm_1.ManyToOne)(
      () => User_1.User,
      (user) => user.leaveApprovalsTaken,
    ), // You might want a property on User to see approvals they've done
